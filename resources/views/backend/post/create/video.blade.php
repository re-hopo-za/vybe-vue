...
@section('title', 'ایجاد مطلب ویدئویی')
        ...
        <div class="d-sm-flex align-items-start justify-content-start mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb small">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ایجاد مطلب ویدئویی</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('post.postStore') }}" method="POST" class="row" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="video" name="type" id="type">
