...
@section('title', 'ایجاد مطلب معمولی')
        ...
        <div class="d-sm-flex align-items-start justify-content-start mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb small">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ایجاد مطلب معمولی</li>
                </ol>
            </nav>
        </div>
...
{{--            </div>--}}
            ...
            <div class="card-body">
                ...
                <form action="{{ route('post.postStore') }}" method="POST" class="row" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="default" name="type" id="type">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="text" id="text" class="text" rows="5" tabindex="7">{!! old('text') !!}</textarea>
                        </div>
                    </div>
