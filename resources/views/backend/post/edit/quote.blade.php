...
@section('title', 'ویرایش مطلب نقل قول')
        ...
        <div class="d-sm-flex align-items-start justify-content-start mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb small">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ویرایش مطلب نقل قول</li>
                </ol>
            </nav>
        </div>
                ...
                <form action="{{ route('post.postUpdate', ['post' => $post]) }}" method="POST" class="row" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="text" id="text" class="text" rows="5" tabindex="9">{!! $post->text !!}</textarea>
                        </div>
                    </div>
