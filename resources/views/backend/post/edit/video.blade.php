...
@section('title', 'ویرایش مطلب ویدئویی')
        ...
        <div class="d-sm-flex align-items-start justify-content-start mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb small">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ویرایش مطلب ویدئویی</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('post.postUpdate', ['post' => $post]) }}" method="POST" class="row" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <label for="post_cover">فایل ویدئویی</label>
                                    <input type="file" class="dropify" name="post_cover" id="post_cover"
                                           data-height="280"
                                           data-max-file-size="100M" data-allowed-file-extensions="mpeg mp4"
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="form-label-group">
                            <select class="form-control custom-select-lg b-select @error('category_id') is-invalid @enderror"
                                    id="category_id"
                                    name="category_id" tabindex="2" required="required" title="انتخاب کنید"
                                    data-live-search="true">
                                <optgroup label="Post's Categories">
                                @foreach($categories as $cat)
                                    <option
                                        value="{{ $cat->id }}" {{ $post->category_id == $cat->id ? 'selected' : '' }}>{{ $cat->title }}</option>
                                @endforeach
                                </optgroup>
                            </select>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="form-label-group">
                            <select class="form-control custom-select-lg b-select @error('tag') is-invalid @enderror" id="tags"
                                    name="tags[]" title="انتخاب کنید" data-live-search="true" multiple
                                    data-max-options="4"
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="text" id="text" class="text" rows="5"
                                      tabindex="9">{!! $post->text !!}</textarea>
                        </div>
                    </div>

                    <div class="col-12">
                        <a class="btn btn-outline-secondary mb-1 mb-sm-0" role="button" href="{{ route('post.postList') }}"
                           tabindex="10">بازگشت</a>
                        <button class="btn btn-warning mb-1 mb-sm-0" type="submit" tabindex="11">ویرایش</button>
                    </div>
