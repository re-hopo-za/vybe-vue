        ...
        <div class="d-sm-flex align-items-start justify-content-start mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb small">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ویرایش تگ</li>
                </ol>
            </nav>
        </div>

        <!-- Content Row -->
        <form action="{{ route('tag.tagUpdate', ['tag' => $tag]) }}" method="POST" class="row">
            @method('PATCH')
            @csrf
            ...
            <div class="col-12">
                ...
                <button class="btn btn-warning mb-1 mb-sm-0" type="submit" tabindex="3">ویرایش</button>
            </div>
        </form>
    </div>
@endsection
