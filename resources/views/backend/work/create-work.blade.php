    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <!-- Content Row -->
                <form action="{{ route('work.workStore') }}" method="POST" class="row" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="dropify" name="work_cover" id="work_cover" required="required"
                    ...
                    <div class="col-12">
                        <a class="btn btn-outline-secondary mb-1 mb-sm-0" role="button" href="{{ route('work.workList') }}" tabindex="7">بازگشت</a>
