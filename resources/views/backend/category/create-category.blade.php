...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Content Row -->
        <form action="{{ route('category.categoryStore') }}" method="POST" class="row">
            @csrf
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="form-label-group">
                    <select class="form-control custom-select-lg b-select @error('parent_id') is-invalid @enderror" id="parent_id"
                            name="parent_id" tabindex="2" required="required" title="انتخاب کنید" data-live-search="true">
            ...
            <div class="col-12">
                ...
                <button class="btn btn-success mb-1 mb-sm-0" type="submit" tabindex="7">ذخیره</button>
            </div>
